        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <nav class="flex text-gray-700 dark:text-gray-300 text-sm pb-5" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <a href="{{ route('productosback.index') }}" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white">
                            Productos
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <span class="text-gray-500 dark:text-gray-400">Editar Producto</span>
                    </li>
                </ol>
            </nav>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                <div class="flex justify-between items-center mb-4 p-4 bg-gray-100 dark:bg-gray-700 rounded-lg border border-gray-300 dark:border-gray-600 opacity-70">
                    <!-- Título a la izquierda -->
                    <h3 class="text-lg font-semibold text-gray-500 dark:text-gray-300">
                        Agregar más detalles al producto
                        <span class="text-sm italic text-gray-400 dark:text-gray-400"> (Próximamente)</span>
                    </h3>

                    <!-- Botones deshabilitados a la derecha -->
                    <div class="flex space-x-2">
                        ...
                        <button type="button" disabled
                            class="bg-green-600 text-white px-4 py-2 rounded-lg cursor-not-allowed opacity-50">
                ...
                <form action="{{ route('productosback.update', $producto->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="especificaciones" rows="4"
                            class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('especificaciones') border-red-500 @enderror">{{ old('especificaciones', $producto->especificaciones) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="garantia" value="{{ old('garantia', $producto->garantia) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date"
                            ...
                            value="{{ old('fecha_lanzamiento', $producto->fecha_lanzamiento ? \Carbon\Carbon::parse($producto->fecha_lanzamiento)->toDateString() : '') }}"
