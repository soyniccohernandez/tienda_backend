<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center mb-6 space-y-2 sm:space-y-0">
                <form action="{{ route('productosback.index') }}" method="GET" class="flex flex-1 space-x-2">
                    <input type="text" name="search" placeholder="Buscar producto por nombre o marca..."
                ...
                <a href="{{ route('productosback.create') }}"
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right space-x-2">
                                <a href="{{ route('productosback.edit', $producto) }}"
                                    class="text-indigo-600 hover:text-indigo-900">Editar</a>

                                <form action="{{ route('productosback.destroy', $producto) }}" method="POST" class="inline delete-producto-form">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button"
                                        class="text-red-600 hover:text-red-900 delete-producto-button">
                                        Eliminar
                                    </button>
                                </form>
                            </td>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const deleteButtons = document.querySelectorAll('.delete-producto-button');
