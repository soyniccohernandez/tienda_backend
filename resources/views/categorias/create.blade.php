        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <nav class="flex text-gray-700 dark:text-gray-300 text-sm pb-5" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <span class="text-gray-500 dark:text-gray-400">Nueva Categoría</span>
                    </li>
                </ol>
            </nav>
                ...
                <form action="{{ route('categorias.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="descripcion" rows="4"
                            class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('descripcion') border-red-500 @enderror">{{ old('descripcion') }}</textarea>
                        @error('descripcion')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
